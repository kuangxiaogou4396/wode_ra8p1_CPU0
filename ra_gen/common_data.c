...
const mipi_phy_cfg_t g_mipi_phy0_cfg =
		{
				.pll_settings =
						...
						- 1, .p_timing = &g_mipi_phy0_timing, .dsi_mode = (1), };
...
const mipi_dsi_extended_cfg_t g_mipi_dsi0_extended_cfg = { .dsi_seq0.ipl = (12),
		...
		.dsi_rxie = R_MIPI_DSI_RXIER_BTAREND_Msk | R_MIPI_DSI_RXIER_LRXHTO_Msk
				...
				| 0x0, .dsi_ferrie = R_MIPI_DSI_FERRIER_HTXTO_Msk
				| R_MIPI_DSI_FERRIER_LRXHTO_Msk | R_MIPI_DSI_FERRIER_TATO_Msk
				| R_MIPI_DSI_FERRIER_ESCENT_Msk | R_MIPI_DSI_FERRIER_SYNCESC_Msk
				| R_MIPI_DSI_FERRIER_CTRL_Msk | R_MIPI_DSI_FERRIER_CLP0_Msk
				| R_MIPI_DSI_FERRIER_CLP1_Msk | 0x0, .dsi_plie = 0x0,
		.dsi_vmie = R_MIPI_DSI_VMIER_VBUFUDF_Msk | R_MIPI_DSI_VMIER_VBUFOVF_Msk
				| 0x0, .dsi_sqch0ie = R_MIPI_DSI_SQCH0IER_AACTFIN_Msk
				| R_MIPI_DSI_SQCH0IER_ADESFIN_Msk
				| R_MIPI_DSI_SQCH0IER_TXIBERR_Msk
				| R_MIPI_DSI_SQCH0IER_RXFERR_Msk
				| R_MIPI_DSI_SQCH0IER_RXFAIL_Msk
				| R_MIPI_DSI_SQCH0IER_RXPFAIL_Msk
				...
				R_MIPI_DSI_SQCH1IER_AACTFIN_Msk
						...
						| R_MIPI_DSI_SQCH1IER_SIZEERR_Msk
						| R_MIPI_DSI_SQCH1IER_TXIBERR_Msk
						| R_MIPI_DSI_SQCH1IER_RXFERR_Msk
...
const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
		...
		.sync_pulse = (0), .data_type = MIPI_DSI_VIDEO_DATA_16RGB_PIXEL_STREAM,
				.virtual_channel_id = 0,

				.vertical_active_lines = 800, .vertical_sync_lines = 2,
				.vertical_back_porch = (42 - 2), .vertical_front_porch = (884
						- 800 - 42 - 2), .vertical_sync_polarity =
						(DISPLAY_SIGNAL_POLARITY_LOACTIVE
								!= DISPLAY_SIGNAL_POLARITY_HIACTIVE),

				.horizontal_active_lines = 480, .horizontal_sync_lines = 2,
				.horizontal_back_porch = (12 - 2), .horizontal_front_porch =
						(674 - 480 - 12 - 2), .horizontal_sync_polarity =
						(DISPLAY_SIGNAL_POLARITY_LOACTIVE
								!= DISPLAY_SIGNAL_POLARITY_HIACTIVE),

				.video_mode_delay = 5926 /* This value was calculated by FSP. An override is available but not recommended for most users */,
				...
				.bta_timeout = 0, .lprw_timeout = (0
						<< R_MIPI_DSI_PRESPTOLPSETR_LPRTO_Pos) | 0,
...
const display_cfg_t g_display0_cfg =
		...
		{ .coordinate = { .x = 0, .y = 0 }, .fade_control =
				...
				.output =
						{ .htiming = { .total_cyc = 674, .display_cyc = 480,
								.back_porch = 12, .sync_width = 2,
								.sync_polarity =
										DISPLAY_SIGNAL_POLARITY_LOACTIVE },
								.vtiming =
										{ .total_cyc = 884, .display_cyc = 800,
												.back_porch = 42, .sync_width =
														2,
												.sync_polarity =
														DISPLAY_SIGNAL_POLARITY_LOACTIVE },
				...
				.p_callback = Display_callback, .p_context = NULL,
